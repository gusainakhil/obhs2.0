...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        ...
        $stmt = $mysqli->prepare("SELECT app_password FROM OBHS_users WHERE user_id = ?");
        ...
        if ($result->num_rows === 1) {
            ...
            if (password_verify($current_password, $row['app_password'])) {
                // Hash new password
                $hashed_password = password_hash($new_password, PASSWORD_DEFAULT);

                // Update password in database
                $update_stmt = $mysqli->prepare("UPDATE OBHS_users SET app_password = ? WHERE user_id = ?");
            ...
            <main class="flex-1 overflow-y-auto p-4 lg:p-6">
                ...
                <div class="max-w-2xl mx-auto">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <form method="POST" action="change-app-password.php">
