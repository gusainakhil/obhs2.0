...
function getAllFeedbackDetailsWithoutGrade($train_no, $from_date, $to_date, $coach_type) {
    global $mysqli;
    $where = [];
...
$headerInfo = "Station: $station_name | UP: $up | DOWN: $down | From: $from_date | To: $to_date";
...
foreach ($trains as $train) {
    ...
    foreach ($coach_types as $coach_type) {
        ...
        $feedbackData = feedback_calculation_coach_wise_without_grade($train, $from_date, $to_date, $coach_type);
        ...
        $headerInfo = "Station: $station_name | Train: $train | From: $from_date | To: $to_date";
...
foreach ($trains as $train) {
    ...
    foreach ($coach_types_detail as $coach_type) {
        ...
        $feedbackData = getAllFeedbackDetailsWithoutGrade($train, $from_date, $to_date, $coach_type);
        ...
        $headers = array_merge($headers, ['Train']);
