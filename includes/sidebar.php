...
<aside id="sidebar" 
  ...
  $user_id = $_SESSION['user_id'];   // Logged-in user
        ...
        ?>
        <a href="train-information.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-300 mb-1 hover:bg-slate-700 transition"> <i class="fas fa-file-alt w-5"></i> <span class="text-sm font-medium">Train Report</span> </a>
        <a href="feedback-target.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-300 mb-1 hover:bg-slate-700 transition"> <i class="fas fa-bullseye w-5"></i> <span class="text-sm font-medium">Feedback Target</span> </a>
        <a href="view-feedback-target.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-300 mb-1 hover:bg-slate-700 transition"> <i class="fas fa-bullseye w-5"></i> <span class="text-sm font-medium">View Feedback Target</span> </a>
        <a href="create-employee.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-300 mb-1 hover:bg-slate-700 transition"> <i class="fas fa-user-plus w-5"></i> <span class="text-sm font-medium">Create Employee</span> </a>
        <a href="view-employee.php" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-300 mb-1 hover:bg-slate-700 transition"> <i class="fas fa-users w-5"></i> <span class="text-sm font-medium">View Employee</span> </a>
