...
$row++;
$nonAcFeedbackData = feedback_calculation_coach_wise_without_grade($train_no, $from_date, $to_date, 'NON-AC');
...
$sheet->fromArray(['SR. No.', 'Coach No.', 'Feedback Target', 'Achieved No. of Feedbacks', 'Avg P.S.I'], null, 'A'.$row);
$row++;
$tteFeedbackData = feedback_calculation_coach_wise_without_grade($train_no, $from_date, $to_date, 'TTE');
...
header('Content-Disposition: attachment;filename="without-grade-train-report.xlsx"');
