...
//?train=14807&coach=A1&from_date=2025-11-18&to_date=2025-11-24&coach_type=AC
$station_name = getStationName($_SESSION['station_id']);
...
<head>
    ...
    <title>Feedback Details Without Grade - <?php echo htmlspecialchars($station_name); ?></title>
...
<script>
    function exportExcel() {
        ...
        window.location.href = 'without-grade-all-feedback-detail-report-excel.php?' + params.toString();
    }
</script>
                ...
                <div class="table-wrapper">
                    <table class="feedback-table">
                        ...
                        <tbody>
                            <?php
                            $passenger_details_coach_type = get_passenger_details_data_coach_type_wise_without_grade(
                                $train_no,
                                $coach_type,
                                $from_date,
                                $to_date
                            ...
                            if (!empty($passenger_details_coach_type)) {
                                ...
                                echo "<tr><td colspan='14' style='text-align:center;color:red;'>No Data Found</td></tr>";
                            }
                            ?>
