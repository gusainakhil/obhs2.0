                        ...
                        <div class="col-12">
                            <div class="card info-card">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="bi bi-person-circle"></i> User Details Beatle Analytics <img src="assets/img/logo-white.png" alt="Beatle Analytics Logo" height="35px"> </h3>
                                ...
                                <div class="card-body">
                                    <!-- Basic Information -->
                                    <h5 class="section-title"><i class="bi bi-info-circle-fill"></i> Basic Information</h5>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="info-row">
                                            ...
                                            <div class="info-row">
                                                <span class="info-label"><i class="bi bi-person-fill"></i> Username</span>
                                                <span class="info-value"><?php echo htmlspecialchars($user['username']); ?></span>
                                            </div>
                                            <div class="info-row">
                                                <span class="info-label"><i class="bi bi-building"></i> Organisation Name</span>
                                                <span class="info-value"><?php echo htmlspecialchars($user['organisation_name']); ?></span>
                                            </div>
                                            <div class="info-row">
                                                <span class="info-label"><i class="bi bi-geo-alt-fill"></i> Station</span>
                                                <span class="info-value"><?php echo htmlspecialchars($user['station_name'] ?? 'N/A'); ?></span>
                                            </div>
                                             <div class="info-row">
                                                <span class="info-label"><i class="bi bi-box-arrow-up-right"></i> Login Link</span>
                                                <span class="info-value"><a href="https://obhs.beatleanalytics.in/" target="_blank" class="link-display">https://obhs.beatleanalytics.in/</a></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="info-row">
                                            ...
                                            <div class="info-row">
                                                <span class="info-label"><i class="bi bi-key-fill"></i> Password (Hashed)</span>
                                                <span class="info-value">
                                                    <div class="password-display"><?php echo htmlspecialchars($user['password']); ?></div>
                                                </span>
                                            </div>
                                            <div class="info-row">
                                                <span class="info-label"><i class="bi bi-ticket-perforated"></i> PNR Functionality</span>
                                                <span class="info-value">
                                                    <?php 
                                    ...
                                    <h5 class="section-title mt-4"><i class="bi bi-calendar-check-fill"></i> Subscription Information</h5>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="info-row">
                                                <span class="info-label"><i class="bi bi-calendar-plus"></i> Start Date</span>
                                                <span class="info-value"><?php echo htmlspecialchars($user['start_date']); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="info-row">
                                                <span class="info-label"><i class="bi bi-calendar-x"></i> End Date</span>
                                                <span class="info-value"><?php echo htmlspecialchars($user['end_date']); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="info-row">
                                                <span class="info-label"><i class="bi bi-hourglass-split"></i> Days Remaining</span>
                                                <span class="info-value">
                                                    <?php 
                                                    if ($is_active) {
                                    ...
                                    <!-- Assigned Reports -->
                                    <h5 class="section-title mt-4"><i class="bi bi-file-earmark-text-fill"></i> Assigned Reports</h5>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table modern-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><span class="badge badge-custom-info table-badge"><?php echo $i++; ?></span></td>
                                                        <td><i class="bi bi-file-text me-2"></i><?php echo htmlspecialchars($report['reports_name']); ?></td>
                                                    </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
                                    ...
                                    <h5 class="section-title mt-4"><i class="bi bi-question-circle-fill"></i> Questions</h5>
                                    <div class="table-responsive">
                                        <table class="table modern-table">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><span class="badge badge-custom-info table-badge"><?php echo $i++; ?></span></td>
                                                    <td><i class="bi bi-chat-left-text me-2"></i><?php echo htmlspecialchars($q['eng_question']); ?></td>
                                                    <td><i class="bi bi-translate me-2"></i><?php echo htmlspecialchars($q['hin_question']); ?></td>
                                                    <td><span class="badge badge-custom-warning"><?php echo htmlspecialchars($q['type']); ?></span></td>
                                                </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
                                    ...
                                    <h5 class="section-title mt-4"><i class="bi bi-bookmark-star-fill"></i> Markings</h5>
                                    <div class="table-responsive">
                                        <table class="table modern-table">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><span class="badge badge-custom-info table-badge"><?php echo $i++; ?></span></td>
                                                    <td><i class="bi bi-tag-fill me-2"></i><?php echo htmlspecialchars($m['category']); ?></td>
                                                    <td><strong><?php echo htmlspecialchars($m['value']); ?></strong></td>
