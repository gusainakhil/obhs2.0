...
<?php
    ...
    foreach ($trains as $current_train) {
        ...
        foreach ($coach_types as $coach_type) {
            $feedbackData = feedback_calculation_coach_wise_without_grade($current_train, $from_date, $to_date, $coach_type);
    ...
    foreach ($trains_for_detail as $detail_train) {
        ...
        foreach ($coach_types_detail as $coach_type) {
            ...
            $feedbackData = getAllFeedbackDetailsWithoutGrade($detail_train, $from_date, $to_date, $coach_type);
            $max_feedbacks = 0;
