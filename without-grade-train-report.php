...
<head> 
    ...
    <title>Train Report Without Grade - <?php echo htmlspecialchars($station_name); ?></title>
...
<body class="bg-slate-50">
        ...
        <main class="p-4 lg:p-6">
            ...
            <div class="max-w-full mx-auto">
                ...
                <table class="table-report">
                    ...
                    <tbody>
                        <?php
                        $acFeedbackData = feedback_calculation_coach_wise_without_grade($train_no, $from_date, $to_date, 'AC');
                        ...
                        if (empty($coachList)) {
                            ...
                            foreach ($coachList as $coach_no => $data) {
                                ...
                                echo '<a href="without-grade-feedback-details.php?' . $query . '"style="color:#2563eb;font-weight:600;text-decoration:none;" target="_blank"> ';
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td><a href="without-grade-all-feedback-detail-report.php?<?php echo $query; ?>" target="_blank" style="color:blue"><?php echo $final_total_passenger; ?></a>
                            </td>
                ...
                <table class="table-report">
                    ...
                    <tbody>
                        ...
                        $nonAcFeedbackData = feedback_calculation_coach_wise_without_grade(
                            $train_no,
                            $from_date,
                            $to_date,
                            'NON-AC'
                        ...
                        if (empty($coachList)) {
                            ...
                            foreach ($coachList as $coach_no => $data) {
                                ...
                                echo '<a href="without-grade-feedback-details.php?' . $query2 . '" style="color:#2563eb;font-weight:600;text-decoration:none;" target="_blank"> ';
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td><a
                                    href="without-grade-all-feedback-detail-report.php?<?php echo $query2; ?>"
            ...
            <table class="table-report">
                ...
                <tbody>
                    ...
                    $tteFeedbackData = feedback_calculation_coach_wise_without_grade(
                        $train_no,
                        $from_date,
                        $to_date,
                        'TTE'
                    ...
                    if (empty($coachList)) {
                        ...
                        foreach ($coachList as $coach_no => $data) {
                            ...
                            echo '<a href="without-grade-feedback-details.php?' . $query3 . '" style="color:#2563eb;font-weight:600;text-decoration:none;" target="_blank"> ';
                            echo $passenger_count;
                            echo "</a>";
                            echo "</td>";
                            echo "<td>{$percentage_display}</td>";
                ...
                <tfoot>
                    <tr>
                        ...
                        <td><a href="without-grade-all-feedback-detail-report.php?<?php echo $query3; ?>"
                                style="color:#2563eb;font-weight:600;text-decoration:none;" target="_blank"><?php echo $total_passenger_sum; ?></a>
                        </td>
    ...
    <script>
        ...
        function exportExcel() {
            ...
            window.location.href = 'without-grade-train-report-excel.php?' + params.toString();
        }
        ...
        function exportAllInOne() {
            ...
            window.location.href = 'without-grade-train-report-all-excel.php?' + params.toString();
        }
        ...
        function printAllInOne() {
            ...
            window.open('without-grade-train-report-all-detail-print.php?' + params.toString(), '_blank');
        }
